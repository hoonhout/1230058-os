...
D=xlsread(file_name,'Sheet2','E2:E9');  %D={'240' '270' '315'};
U=xlsread(file_name,'Sheet2','F2:F11');
alfa           = 0.0185;
            ...
            for u4=1:length(L)
                ...
                if create_input==1;
                    ...
                    if u1==1
                        ...
                        fmaster=['master_NZ.SWN'];%Based on A02 from Caroline
                    ...
                    elseif u1==2
                        fmaster=['master_OO.SWN'];%Based on A02 from Caroline
                        fnew=['D' sprintf('%0.3d',round(D(u3))) '\' folder(c).name '\' folder(c).name '.SWN'];
                        replace_string_in_file(fmaster,fnew,'[U]',num2str(U(u2)));
                        replace_string_in_file(fnew,fnew,'[Uow]',num2str((Uow(u2)),'%5.2f'));
                        replace_string_in_file(fnew,fnew,'[D]',num2str(D(u3)));
