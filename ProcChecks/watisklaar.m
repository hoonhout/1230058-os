function watisklaar(welkedir)
%welkedir='RUN_TEST7';

runidlist=[];
mainpath=['p:\1230058-os\swanmodel\TEST01\' welkedir '\'];
...
pcolor(z);
patch([1 57 57 1],[30 30 51 51],'k');
title([mainpath ': Donker blauw heeft nog geen *.prt file']);
set(gcf,'paperposition',[0.05 0.25 20 10],'Position',[200 200 1600 800]);
set(gca,'Position',[0.07 0.04 0.86 0.85])
outfile=['p:\1230058-os\swanmodel\TEST01\CONTROL\checkbulk\watisklaar' welkedir '.png'];
print('-dpng',outfile)
